...
export const memo = r(function* <A, B, C, D extends unknown[]>(generator: (...args: D) => Generator<A, B, C>, args: D) {
...
export const memoPlugin = () => {
  return {
    ...
    exec: ({ generator, args }: PluginYield, callSite: CallSite[], ctx: MemoFrameContext) => {
